...
import { toggleFollow } from "@/actions/users.actions";
    ...
    <div className="max-w-3xl mx-auto">
      <div className="grid grid-cols-1 gap-6">
        ...
        <Tabs defaultValue="posts" className="w-full">
          <TabsList className="w-full justify-start border-b rounded-none h-10 p-0 bg-transparent gap-0">
            <TabsTrigger
              value="posts"
              className="flex items-center gap-2 rounded-none border-b-2 border-transparent data-[state=active]:border-primary
               data-[state=active]:bg-transparent data-[state=active]:shadow-none px-6 h-10 font-semibold"
            >
